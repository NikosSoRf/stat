...
# Преобразуем в numpy arrays для избежания проблем с индексацией
X_np = X.values
y_np = y.values
...
print("\n" + "="*80)
print("СТАТИСТИЧЕСКИЕ ТЕСТЫ ДЛЯ СРАВНЕНИЯ АЛГОРИТМОВ")
print("="*80)

# Собираем данные для статистических тестов
models_data = {
    "optimized_base_models": optimized_base_models,
...
statistical_tests.perform_statistical_tests(models_data)
